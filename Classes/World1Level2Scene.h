...
@interface World1Level2Scene : CCScene {}
@end

@interface World1Level2Layer : CCLayer {
	CCSprite *player;
	b2World* world;
	b2Body *body;
...
//shots is number of blocks user can place
@property int shots;

//blocks is an array of all the block positions
